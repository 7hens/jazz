...
> ✅ 已解禁(2026-09-08 千字谷 ch1 立项时):「汉字书写笔顺」划界为「不做笔画顺序书写教学」→ 放行**汉字部件拖拽拼装**(见千字谷 ch1 spec);「绘画作品检测」划界为「不做绘画内容语义识别」→ 放行**拍照→亮度抠图→贴图进场景**(对应 P1 绘画题型提前立项,见想法池行)。边界措辞同步见下方「坚决不做」两条。
