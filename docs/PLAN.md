...
- [ ] `P0` `[feature]` 拼音短教单元锚点重构 — 人工验收发现:合体 chip 读整词(缺音节↔汉字对齐)、j/i 等 9 对声母/韵母共享同锚(emoji/读音不独立)。修:decompose 产音节汉字、catalogs 每单元独立单音锚点、demo/quiz 消费对齐 — [design](superpowers/specs/2026-09-06-pinyin-anchor-redesign-design.md)
