...
export const PINYIN_INITIALS: InitialUnit[] = [
  ...
  { symbol: 'k', anchorPinyin: 'kū', anchorHanzi: '哭', anchorEmoji: '😭' },
  ...
  { symbol: 'zh', anchorPinyin: 'zhī', anchorHanzi: '蜘', anchorEmoji: '🕷️' },
  { symbol: 'ch', anchorPinyin: 'chǐ', anchorHanzi: '尺', anchorEmoji: '📏' },
  { symbol: 'sh', anchorPinyin: 'shī', anchorHanzi: '狮', anchorEmoji: '🦁' },
  { symbol: 'r', anchorPinyin: 'rì', anchorHanzi: '日', anchorEmoji: '🌞' },
  { symbol: 'z', anchorPinyin: 'zú', anchorHanzi: '足', anchorEmoji: '🦶' },
  { symbol: 'c', anchorPinyin: 'cì', anchorHanzi: '刺', anchorEmoji: '🦔' },
  { symbol: 's', anchorPinyin: 'sǎn', anchorHanzi: '伞', anchorEmoji: '☂️' },
  { symbol: 'y', anchorPinyin: 'yǐ', anchorHanzi: '蚁', anchorEmoji: '🐜' },
  { symbol: 'w', anchorPinyin: 'wǔ', anchorHanzi: '舞', anchorEmoji: '💃' },
]
